...
export interface ApiAulaAula extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    chefid: Schema.Attribute.Relation<
      'manyToOne',
      'api::cooking-user.cooking-user'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cuisine: Schema.Attribute.Enumeration<
      ['Japonesa', 'Italiana', 'Francesa', 'Russa', 'Alem\u00E3', 'Mexicana']
    >;
...
export interface ApiCookingUserCookingUser extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    role: Schema.Attribute.Enumeration<['aluno', 'chefe']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiLessonLesson extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    aula: Schema.Attribute.Relation<'manyToOne', 'api::aula.aula'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
    type: Schema.Attribute.Enumeration<['texto', 'v\u00EDdeo ', 'imagem']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_lessons: Schema.Attribute.Relation<
...
export interface ApiUserLessonUserLesson extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    lessonid: Schema.Attribute.Relation<'manyToOne', 'api::lesson.lesson'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::user-lesson.user-lesson'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    statusLesson: Schema.Attribute.Enumeration<['pending', 'completed']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::cooking-user.cooking-user': ApiCookingUserCookingUser;
